...
export default async function Footer() {
    ...
    return (
        <footer className="bg-black border-t border-black" style={{ fontFamily: 'var(--font-caveat)' }}>
            <div className="w-full md:mx-auto">
                <div className="flex justify-between items-center py-4 w-full min-w-full">
                    {/* Copyright Notice */}
